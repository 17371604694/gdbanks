...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(
       ...
       // formAuthenticationFilter.setSuccessUrl(adminPath + "?login");
        ...
        filterChainDefinitionMap.put(adminPath+"/backgroundmanage/imagemanage/bankImage/getPath","anon");//设置拦截器不拦截
        filterChainDefinitionMap.put(adminPath+"/logins/**","anon");//设置拦截器不拦截
        filterChainDefinitionMap.put(adminPath+"/public/**","anon");//设置拦截器不拦截
