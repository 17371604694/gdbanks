...
public interface BaseMapper<T> {
	...
	public List<T> findPage1(T entity);

	public List<T> findListSearch(T entity);

	/**
	 * 查询发稿统计数据列表，如果需要分页，请设置分页对象，如：entity.setPage(new Page<T>());
	 * @param entity
	 * @return
	 */
	public List<T> findStatisticalList(T entity);
	 ...
	 * @return
	 */
	public List<T> findList222(T entity);
	 ...
	 * @return
	 */
	public List<T> findList2(T entity);
	 ...
	 * @return
	 */
	public int saveselect(T entity);
	...
	/*查询未审核数据*/
	public List<T> findallPage(T distributeContent);
