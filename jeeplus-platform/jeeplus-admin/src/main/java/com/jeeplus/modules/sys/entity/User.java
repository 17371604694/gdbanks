...
public class User extends DataEntity<User> {
	...
	private String statement;	// 工作职责
	private String roleName;	// 角色临时中文名
	...
	public User() {
		super();
		this.loginFlag = JeePlusProperites.YES;
	}
	...
	@ExcelField(title="岗位", align=2, sort=26)
	...
	@ExcelField(title="归属公司", align=2, sort=27)
