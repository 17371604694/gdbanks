...
$(document).ready(function() {
    $('#administrativeArchivesApproveTable').bootstrapTable({
        ...
        url: "${ctx}/consignfileapproval/administrativearchives/administrativeArchivesApprove/data2?stateStep=7",
        ...
        columns: [
            ...
            ,{
                ...
                title: '办公室主管行领导',
                sortable: true,
                sortName: 'officeSupervisorLeader'
...
*/
            ...
            //             /*<% if(shiro.hasPermission("consignfileapproval:administrativearchives:administrativeArchivesApprove:view")){ %>
            //        '<a class="view btn btn-icon waves-effect waves-light btn-custom btn-xs m-r-5"> <i class="fa fa-search"></i></a>',
            //            <% } %>*/
            //             <% if(shiro.hasPermission("consignfileapproval:administrativearchives:administrativeArchivesApprove:edit")){ %>
...
//新增表单页面
function add() {
    jp.openSaveDialog('新增文书档案利用审批单', "${ctx}/consignfileapproval/administrativearchives/administrativeArchivesApprove/form/add",'1500px', '800px');
}
//编辑表单页面
function edit(id){
    if(!id){
    ...
    jp.openSaveDialog('编辑文书档案利用审批单', "${ctx}/consignfileapproval/administrativearchives/administrativeArchivesApprove/form/edit?id="+id,'1500px', '800px');
}
//查看表单页面
function view(id) {
    if(!id){
    ...
    jp.openViewDialog('查看文书档案利用审批单', "${ctx}/consignfileapproval/administrativearchives/administrativeArchivesApprove/form/view?id="+id,'1500px', '800px');
}
</script>