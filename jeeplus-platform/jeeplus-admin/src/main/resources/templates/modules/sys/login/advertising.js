...
$(document).ready(function() {
    $('#advertisingAuditTable').bootstrapTable({
        ...
        url: "${ctx}/advertisingaudit/advertising/advertisingAudit/data2?stateStep=6",
        ...
        columns: [
            ...
            //         var result = [
            //             <% if(shiro.hasPermission("advertisingaudit:advertising:advertisingAudit:view")){ %>
            ...
            //         <% } %>
            //     <% if(shiro.hasPermission("advertisingaudit:advertising:advertisingAudit:del")){ %>
...
//新增表单页面
function add() {
    jp.openSaveDialog('新增广告审核', "${ctx}/advertisingaudit/advertising/advertisingAudit/form/add",'800px', '500px');
}
//编辑表单页面
function edit(id){
    if(!id){
    ...
    jp.openSaveDialog('编辑广告审核', "${ctx}/advertisingaudit/advertising/advertisingAudit/form/edit?id="+id,'800px', '500px');
}
//查看表单页面
function view(id) {
    if(!id){
    ...
    jp.openViewDialog('查看广告审核', "${ctx}/advertisingaudit/advertising/advertisingAudit/form/view?id="+id,'800px', '500px');
}
</script>