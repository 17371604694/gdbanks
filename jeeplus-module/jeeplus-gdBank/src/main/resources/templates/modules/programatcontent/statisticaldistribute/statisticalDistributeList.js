...
$(document).ready(function() {
    ...
    $('#distributeContentTable').bootstrapTable({
        ...
        url: "${ctx}/programatcontent/programatcont/distributeContent/statisticalDistributeData",
        ...
        // }
        ,{
            field: 'officeName', //原programatId
            title: '部门',
        }
        ,{
            field: 'author', //原programatId
            title: '人员',
        }
        ,{
            field: 'content', //原programatId
            title: '栏目',
        }
        ,{
                field: 'stepSum', //原programatParentid
                title: '数量',
                // sortable: true,
                // sortName: 'remarks'
...
function edit(id){
    ...
    jp.openSaveDialog('编辑发稿', "${ctx}/programatcontent/programatcont/distributeContent/form/edit?psnameId=${distributeContent.programatIdName}&id="+id,'80%', '80%');
}
...
//新增表单页面
function add() {
    jp.openSaveDialog('新增发稿', "${ctx}/programatcontent/programatcont/distributeContent/form/add?psnameId=${distributeContent.programatIdName}",'80%', '80%');
}
...
function view(id) {
    ...
    jp.openViewDialog('查看发稿', "${ctx}/programatcontent/programatcont/distributeContent/form/view?psnameId=${distributeContent.programatIdName}&id="+id,'80%', '80%');
}
</script>