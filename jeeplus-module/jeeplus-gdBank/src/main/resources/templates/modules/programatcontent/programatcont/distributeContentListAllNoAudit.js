   ...
   // 已审核稿件
	...
	$('#distributeContentTable').bootstrapTable({
		  //请求方法
               ...
               url: "${ctx}/programatcontent/programatcont/distributeContent/allDataNoAudit?psnameId=${distributeContent.programatIdName}",
          ...
          /*  ,{
			...
			,{
			   ...
			   events: {
                   ...
                   'click .bh': function (e, vzdalue, row, index) {
                       bh(row.id);
			   ...
			   formatter:  function operateFormatter(value, row, index) {
                   ...
                   // retun.push(['<a class="edit btn btn-icon waves-effect waves-light btn-custom btn-xs m-r-5"> <i class="fa fa-pencil"></i></a>']);
                   if(user.id=="1"||user.id=="c6d9c07543f64a21b4454c23c8dedde2"){
