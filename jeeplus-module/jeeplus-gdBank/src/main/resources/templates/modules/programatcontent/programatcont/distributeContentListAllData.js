   ...
   // 全部稿件
	...
	$('#distributeContentTable').bootstrapTable({
		  //请求方法
               ...
               url: "${ctx}/programatcontent/programatcont/distributeContent/allDatalist?psnameId=${distributeContent.programatIdName}",
          ...
          /*  ,{
			...
			,{
			   ...
			   formatter:  function operateFormatter(value, row, index) {
                   ...
                   //
                   // }
                   if("1"==user.id||"c6d9c07543f64a21b4454c23c8dedde2"==user.id){
