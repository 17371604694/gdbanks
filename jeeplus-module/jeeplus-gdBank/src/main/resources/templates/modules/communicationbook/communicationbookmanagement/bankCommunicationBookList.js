...
$(document).ready(function() {
	...
	$('#table').bootstrapTable({
		...
		url: "${ctx}/communicationbook/communicationbookmanagement/bankCommunicationBook/data",
	...
	$("#btnImportExcel").click(function(){//导入Excel
		...
		jp.uploadFile(importForm,"${ctx}/communicationbook/communicationbookmanagement/bankCommunicationBook/import",function (data) {
			if(data.success){
	...
	$("#btnDownloadTpl").click(function(){//下载模板文件
		jp.downloadFile('${ctx}/communicationbook/communicationbookmanagement/bankCommunicationBook/import/template');
	})

	$("#export").click(function(){//导出Excel文件
		// jp.downloadFile('${ctx}/communicationbook/communicationbookmanagement/bankCommunicationBook/export');
		location.href="${ctx}/communicationbook/communicationbookmanagement/bankCommunicationBook/export";
	})
...
function deleteAll(ids){
	...
	jp.confirm('确认要删除选中通讯录吗？',  function(){
		jp.loading();
...
function view(id){
	...
	jp.openViewDialog('查看通讯录', "${ctx}/sys/user/form?id=" + id,'800px', '500px');
...
function edit(id){
	...
	jp.openSaveDialog('编辑通讯录', "${ctx}/sys/user/form?id=" + id,'800px', '500px');
