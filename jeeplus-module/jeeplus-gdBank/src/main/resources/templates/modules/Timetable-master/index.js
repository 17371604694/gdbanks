(function(global) {
  ...
  Timetables.prototype = {
    _init: function(option) {
      ...
      var leftHandTextDom = document.createElement("div");//左列第一项
      leftHandTextDom.className = 'left-hand-TextDom';//添加一个class
      leftHandTextDom.style.height = coursesHeadDomHeight + 'px';//指定div高度
      ...
      leftHandText.forEach(function (item) {
        ...
        leftHandTextItem.innerText = item;//插入数据
